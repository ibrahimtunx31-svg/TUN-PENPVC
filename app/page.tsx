export default function TuncPenPVC() {
  ...
  return (
    <div className="bg-white text-neutral-900 overflow-x-hidden">
      {/* TOP BAR */}
      <div className="bg-[#0D1B2A] text-white text-sm py-3 px-6">
      ...
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-white py-24">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-neutral-200 leading-relaxed mb-10 max-w-2xl">
              Tunç Pen PVC olarak pimapen, sineklik ve cam balkon alanında
      ...
      {/* SERVICES */}
      <section id="hizmetler" className="py-28 bg-[#F5F7FA]">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            {services.map((item, index) => (
              ...
              >
                {/* overflow-hidden eklenerek resmin taşması engellendi */}
                ...
                <div className="p-8 flex flex-col flex-grow justify-between">
                  ...
                  {/* Buton yeni sekmeye açılacak <a> linkine dönüştürüldü */}
                  <a 
                    href={`/hizmet-${index}`} 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="bg-blue-600 text-white px-6 py-3 rounded-xl font-bold hover:bg-blue-700 transition inline-block text-center w-fit"
                  >
                    Detaylı İncele
                  </a>
                </div>
      ...
      {/* PRODUCTS */}
      <section id="urunler" className="py-28 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col lg:flex-row justify-between gap-10 mb-20">
            ...
            <p className="text-neutral-600 text-lg max-w-2xl leading-relaxed">
              Dayanıklı malzeme, estetik görünüm and profesyonel işçilik ile
      ...
      {/* GALLERY */}
      <section id="galeri" className="py-28 bg-[#F5F7FA]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-20">
            <p className="text-blue-600 font-bold uppercase tracking-[0.3em] text-sm mb-4">
              Galeri
      ...
      {/* ABOUT */}
      <section id="hakkimizda" className="py-28 bg-white">
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-20 items-center">
          ...
          <div>
            ...
            <p className="text-neutral-600 text-lg leading-relaxed mb-10">
              ...
              sineklik ve cam balkon alanında modern çözümler sunuyoruz.
            </p>
            ...
            <div className="grid grid-cols-2 gap-5">
              {[
                ...
                <div
                  key={index}
                  className="bg-[#F5F7FA] rounded-2xl p-5 font-bold"
                >
                  ✓ {item}
                </div>
              ))}
      ...
      {/* CONTACT */}
      <section id="iletisim" className="py-28 bg-[#0D1B2A] text-white">
